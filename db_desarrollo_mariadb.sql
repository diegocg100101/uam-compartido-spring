...
ALTER TABLE usuarios
    ADD FOREIGN KEY (IdDivision) REFERENCES division (IdDivision);
...
ALTER TABLE grupos
    ADD FOREIGN KEY (ClaveUea) REFERENCES uea (Clave);
ALTER TABLE grupos
    ADD FOREIGN KEY (Unidad) REFERENCES unidad (IdUnidad);
ALTER TABLE grupos
    ADD FOREIGN KEY (NoEconomico) REFERENCES usuarios (NoEconomico);
ALTER TABLE grupos
    ADD FOREIGN KEY (Salon) REFERENCES salon (IdSalon);
...
VALUES (1, 'Recursos de la Tierra'),
...
INSERT INTO tronco
VALUES (1, 'Tronco General Divisional'),
       (2, 'Tronco Básico de Carrera'),
       (3, 'Tronco Interdivisional de Fromación Interdisciplinaria'),
       (4, 'Tronco Específico de Carrera'),
       (5, 'Tronco de Integración');
